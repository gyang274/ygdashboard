...
#' Create a sidebar user panel output (client side)
#'
#' This is the UI-side function for creating a dynamic sidebar user panel.
#'
#' @inheritParams menuOutput
#' @family menu outputs
#' @seealso \code{\link{renderMenu}} for the corresponding server-side function
#'   and examples, and \code{\link{sidebarUserPanel}} for the corresponding function
#'   for generating static sidebar menus.
#' @export
sidebarUserPanelOutput <- function(outputId) {
  menuOutput(outputId = outputId, tag = tags$li)
}
...
#' Create a sidebar menu segment output (client side)
#'
#' This is the UI-side function for creating a dynamic sidebar menu segment.
#'
#' @inheritParams menuOutput
#' @family menu outputs
#' @seealso \code{\link{renderMenu}} for the corresponding server-side function
#'   and examples, and \code{\link{menuSegment}} for the corresponding function
#'   for generating static sidebar menu segments.
#' @export
menuSegmentOutput <- function(outputId) {
  menuOutput(outputId = outputId, tag = tags$li)
}
